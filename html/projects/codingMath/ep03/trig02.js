...
window.onload = function() {
  ...
  function render()
  {
    ...
    ctx.moveTo(pathRadiusX, 0);
    ctx.lineWidth = 10;
    ctx.lineCap = "round";
    ctx.strokeStyle = "teal";
    // ctx.lineTo(circleX, circleY + 90);
  ...
  function filledCircle(color, strokeColor,  startx, starty, radius, startDeg, Deg, counterClockwise)
  {
    ...
    ctx.arc(startx, starty, radius+40
            , startDeg, endDeg, counterClockwise);
    ctx.closePath();
 ...
 //   ctx.moveTo(startx, starty);
    ctx.arc(startx + 240, starty + 50, radius - 10
           , startDeg, Math.PI * 1.15, false);
